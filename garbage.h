...
t_color					apply_color(t_color c1, t_color c2, double);
...
void					ft_mlx_key_update(t_data *data, int keycode,
						int state);
void					add_img(t_img_list **head, void);
...
t_vec3					apply_matrix(t_matrix43 matrix, t_vec3);
...
int						add_index(int *indices, int index, int *nums,
						int nums);
